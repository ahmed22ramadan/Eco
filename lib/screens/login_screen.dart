  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    try {
      final googleSignIn = GoogleSignIn(
        serverClientId:
            '853919401925-utc9gi7d47qplsv5rhldphj0vo4notka.apps.googleusercontent.com',
      );
      ...
      // TODO: temporary - remove after diagnosing, replace with t('generic_error')
      setState(() => _error = 'DEBUG: $e');
    } finally {
      if (mounted) setState(() => _loading = false);
    }
  }
